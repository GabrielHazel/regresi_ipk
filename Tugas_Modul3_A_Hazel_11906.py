...
if uploaded_file is not None:
    ...
    model_directory = r'D:\perkuliahan\semester 5\PMDPM\Pertemuan 6\Model Suprevised Learning (Praktek)\Tugas3_A_11906'
    model_path = os.path.join(model_directory, r'Ridge_IPK_model.pkl')
